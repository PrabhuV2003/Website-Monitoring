...
def quick_test():
    ...
    print("=" * 60)
    print(" QUICK EMAIL TEST - ASCENT365")
    print("=" * 60)
    ...
    if not username or username == 'ascent365.monitor@gmail.com':
        print("\n DUMMY CREDENTIALS DETECTED")
        print("   Update config/ascent365.yaml with real Gmail account")
        return False
    
    if not password or password == 'your-app-password-here':
        print("\n DUMMY PASSWORD DETECTED")
        print("   Update config/ascent365.yaml with real App Password")
        return False
